 ...
 * @author taowen
 */
@ImplementedBy(BooleanArrayAssertHelper.Impl.class)
public interface BooleanArrayAssertHelper {

    BooleanArrayAssert assertThat(boolean[] actual);

    @Singleton
    public static class Impl implements BooleanArrayAssertHelper {
